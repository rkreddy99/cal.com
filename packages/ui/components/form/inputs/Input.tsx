  ...
  return (
    <input
      ...
      className={classNames(
        "hover:border-emphasis border-default bg-default placeholder:text-muted text-emphasis disabled:hover:border-default min-h-9 disabled:bg-subtle mb-2 block rounded-md border py-2 px-3 text-sm leading-4 focus:border-neutral-300 focus:outline-none focus:ring-2 focus:ring-neutral-800 disabled:cursor-not-allowed",
        isFullWidth && "w-full",
        props.className
      )}
    />
  ...
  return (
    <div className={classNames(containerClassName)}>
      ...
      {addOnLeading || addOnSuffix ? (
        <div
          dir="ltr"
          className="group relative mb-1 flex items-center rounded-md focus-within:outline-none focus-within:ring-2 focus-within:ring-neutral-800">
          {addOnLeading && (
